...
def  populateTables(_conn):
    ...
    try:
        ...
        userrows = [
            (0,'jellybean', 'jennysmith1@gmail.com', 'Jenny', 'Smith', 'Netflix'),
            (1,'frenzzy', 'cindyyyyyy@yahoo.com', 'Cindy', 'Lin', 'Netflix'),
            (2,'waterdrop', 'b0bSchwartz@gmail.com', 'Bob', 'Schwartz', 'Amazon Prime'),
            (3,'questseeker', 'Marc0G0mez@hotmail.com', 'Marco', 'Gomez', 'Hulu'),
            (4,'foodieaddict', 'katerin@gmail.com', 'Kate', 'Rin', 'Disney+')
        ]
